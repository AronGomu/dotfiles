...
| word    | short description                           | ref in code                                |
| ------- | ------------------------------------------- | ------------------------------------------ |
| repo    | portable config ownership root             | `AGENTS.md`                              |
| source  | native config before deployment             | `config/`                                |
| target  | user path receiving config                  | `docs/deployment.md`                     |
| hub     | single shared skill discovery root          | `config/agents/skills/`                  |
| sync    | validated changes reach authorized remote   | `config/agents/skills/sync-config-aron/`  |
```
